...
--
-- Host: localhost
-- Generation Time: Jan 21, 2023 at 03:09 AM
...
CREATE TABLE `pages` (
  ...
  `photo_gallery_heading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `photo_gallery_status` int NOT NULL,
...
CREATE TABLE `rooms` (
  ...
  `featured_photo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `settings` (
  ...
  `analytic_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
